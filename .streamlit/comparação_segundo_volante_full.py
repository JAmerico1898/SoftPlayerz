...
Participação_Segundo_Volante_Charts_1 = Segundo_Volante_Charts_1.copy()

metrics = Participação_Segundo_Volante_Charts_1.iloc[:, np.r_[3, 72:74, 31, 74]].reset_index(drop=True)
## parameter names
...
Intensidade_Defensiva_Segundo_Volante_Charts = Segundo_Volante_Charts_1.copy()

#Collecting data to plot
metrics = Intensidade_Defensiva_Segundo_Volante_Charts.iloc[:, np.r_[3, 29:33]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
Inteligência_Defensiva_Segundo_Volante_Charts = Segundo_Volante_Charts_1.copy()

#Collecting data to plot
metrics = Inteligência_Defensiva_Segundo_Volante_Charts.iloc[:, np.r_[3, 69:72]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
Transição_Ofensiva_Segundo_Volante_Charts = Segundo_Volante_Charts_1.copy()

#Collecting data to plot
metrics = Transição_Ofensiva_Segundo_Volante_Charts.iloc[:, np.r_[3, 84, 77, 85]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
Impacto_Passe_Segundo_Volante_Charts = Segundo_Volante_Charts_1.copy()

#Collecting data to plot
metrics = Impacto_Passe_Segundo_Volante_Charts.iloc[:, np.r_[3, 75:80]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
Drible_Segundo_Volante_Charts = Segundo_Volante_Charts_1.copy()

#Collecting data to plot
metrics = Drible_Segundo_Volante_Charts.iloc[:, np.r_[3, 48, 54:57]].reset_index(drop=True)
...
Criação_Oportunidades_Segundo_Volante_Charts = Segundo_Volante_Charts_1.copy()

#Collecting data to plot
metrics = Criação_Oportunidades_Segundo_Volante_Charts.iloc[:, np.r_[3, 86, 88:92]].reset_index(drop=True)
