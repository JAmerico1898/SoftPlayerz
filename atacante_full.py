atributos_atacante = ['Participação', 'Pressão na linha alta', 'Ameaça aérea', 'Conexão ofensiva',
                'Movimentação ofensiva', 'Criação de oportunidades', 
                    'Finalização', 'Oportunismo']
...
# Collecting data
attribute_chart_z1 = attribute_chart_z[(attribute_chart_z['Liga']==liga) & (attribute_chart_z['Temporada']==temporada) & (attribute_chart_z['Posição']=="Atacante")]
...
rows_count = attribute_chart_z1[(attribute_chart_z1['Liga'] == liga) & (attribute_chart_z1['Posição'] == "Atacante")].shape[0]
...
attribute_chart_1 = attribute_chart[(attribute_chart['Atleta']==jogadores)&
                                    (attribute_chart['Liga']==liga)&
                                    (attribute_chart['Temporada']==temporada) & 
                                    (attribute_chart['função']=="Atacante") & 
                                    (attribute_chart['Clube']==equipe)]
attribute_chart_per_1 = attribute_chart_per[(attribute_chart_per['Atleta']==jogadores)&
                                            (attribute_chart_per['Liga']==liga)&
                                            (attribute_chart_per['Temporada']==temporada) & 
                                            (attribute_chart_per['função']=="Atacante") & 
...
attribute_chart_1 = attribute_chart[(attribute_chart['Atleta']==jogadores)&(attribute_chart['Liga']==liga)&
                                    (attribute_chart['Temporada']==temporada) & (attribute_chart['função']=="Atacante")&
                                    (attribute_chart['Clube']==equipe)]
...
# Collecting data
attribute_chart_z1 = attribute_chart_z[(attribute_chart_z['Liga']==liga) & (attribute_chart_z['Temporada']==temporada) & (attribute_chart_z['função']=="Atacante")]
#Collecting data to plot
...
# Building the Extended Title"
rows_count = attribute_chart_z1[(attribute_chart_z1['Liga'] == liga) & (attribute_chart_z1['função'] == "Atacante")].shape[0]
...
attribute_chart_per_1 = attribute_chart_per[(attribute_chart_per['Atleta']==jogadores)&
                                            ...
                                            (attribute_chart_per['função']=="Atacante") & (attribute_chart_per['Clube']==equipe)]
#Collecting data to plot
...
# Use the dynamically created HTML string in st.markdown
st.markdown("<h3 style='text-align: center; color: deepskyblue; '>Ameaça Aérea</h3>", unsafe_allow_html=True)
st.markdown(title_html, unsafe_allow_html=True)
...
attribute_chart_z1 = attribute_chart_z[(attribute_chart_z['Liga']==liga) & (attribute_chart_z['Temporada']==temporada) & (attribute_chart_z['função']=="Atacante")]
#Collecting data to plot
metrics = attribute_chart_z1.iloc[:, np.r_[33:38]].reset_index(drop=True)
metrics_ameaça_aérea_1 = metrics.iloc[:, 0].tolist()
metrics_ameaça_aérea_2 = metrics.iloc[:, 1].tolist()
metrics_ameaça_aérea_3 = metrics.iloc[:, 2].tolist()
metrics_ameaça_aérea_4 = metrics.iloc[:, 3].tolist()
metrics_ameaça_aérea_5 = metrics.iloc[:, 4].tolist()
metrics_y = [0] * len(metrics_ameaça_aérea_1)

# The specific data point you want to highlight
highlight = attribute_chart_z1[(attribute_chart_z1['Atleta']==jogadores)& (attribute_chart_z1['Clube']==equipe)]
highlight = highlight.iloc[:, np.r_[33:38]].reset_index(drop=True)
highlight_ameaça_aérea_1 = highlight.iloc[:, 0].tolist()
highlight_ameaça_aérea_2 = highlight.iloc[:, 1].tolist()
highlight_ameaça_aérea_3 = highlight.iloc[:, 2].tolist()
highlight_ameaça_aérea_4 = highlight.iloc[:, 3].tolist()
highlight_ameaça_aérea_5 = highlight.iloc[:, 4].tolist()
highlight_y = 0

# Computing the selected player specific values
highlight_ameaça_aérea_1_value = pd.DataFrame(highlight_ameaça_aérea_1).reset_index(drop=True)
highlight_ameaça_aérea_2_value = pd.DataFrame(highlight_ameaça_aérea_2).reset_index(drop=True)
highlight_ameaça_aérea_3_value = pd.DataFrame(highlight_ameaça_aérea_3).reset_index(drop=True)
highlight_ameaça_aérea_4_value = pd.DataFrame(highlight_ameaça_aérea_4).reset_index(drop=True)
highlight_ameaça_aérea_5_value = pd.DataFrame(highlight_ameaça_aérea_5).reset_index(drop=True)

highlight_ameaça_aérea_1_value = highlight_ameaça_aérea_1_value.iat[0,0]
highlight_ameaça_aérea_2_value = highlight_ameaça_aérea_2_value.iat[0,0]
highlight_ameaça_aérea_3_value = highlight_ameaça_aérea_3_value.iat[0,0]
highlight_ameaça_aérea_4_value = highlight_ameaça_aérea_4_value.iat[0,0]
highlight_ameaça_aérea_5_value = highlight_ameaça_aérea_5_value.iat[0,0]

# Computing the min and max value across all lists using a generator expression
min_value = min(min(lst) for lst in [metrics_ameaça_aérea_1, metrics_ameaça_aérea_2, 
                                    metrics_ameaça_aérea_3, metrics_ameaça_aérea_4,
                                    metrics_ameaça_aérea_5])
min_value = min_value - 0.1
max_value = max(max(lst) for lst in [metrics_ameaça_aérea_1, metrics_ameaça_aérea_2, 
                                    metrics_ameaça_aérea_3, metrics_ameaça_aérea_4,
                                    metrics_ameaça_aérea_5])
max_value = max_value + 0.1
...
# Building the Extended Title"
# Determining player's rank in attribute in league
ameaça_aérea_1_ranking_value = (get_player_rank(jogadores, liga, "Jogadas de cabeça (p90)", attribute_chart_z1))

# Data to plot
output_str = f"({ameaça_aérea_1_ranking_value}/{rows_count})"
full_title_ameaça_aérea_1 = f"Jogadas de cabeça (p90) {output_str} {highlight_ameaça_aérea_1_value}"

# Building the Extended Title"
# Determining player's rank in attribute in league
ameaça_aérea_2_ranking_value = (get_player_rank(jogadores, liga, "Duelos aéreos vencidos no ataque (%)", attribute_chart_z1))

# Data to plot
output_str = f"({ameaça_aérea_2_ranking_value}/{rows_count})"
full_title_ameaça_aérea_2 = f"Duelos aéreos vencidos no ataque (%) {output_str} {highlight_ameaça_aérea_2_value}"

# Building the Extended Title"
# Determining player's rank in attribute in league
ameaça_aérea_3_ranking_value = (get_player_rank(jogadores, liga, "Duelos aéreos vencidos no ataque (p90)", attribute_chart_z1))

# Data to plot
output_str = f"({ameaça_aérea_3_ranking_value}/{rows_count})"
full_title_ameaça_aérea_3 = f"Duelos aéreos vencidos no ataque (p90) {output_str} {highlight_ameaça_aérea_3_value}"

# Building the Extended Title"
# Determining player's rank in attribute in league
ameaça_aérea_4_ranking_value = (get_player_rank(jogadores, liga, "Duelos aéreos vencidos (%)", attribute_chart_z1))

# Data to plot
output_str = f"({ameaça_aérea_4_ranking_value}/{rows_count})"
full_title_ameaça_aérea_4 = f"Duelos aéreos vencidos (%) {output_str} {highlight_ameaça_aérea_4_value}"

# Building the Extended Title"
# Determining player's rank in attribute in league
ameaça_aérea_5_ranking_value = (get_player_rank(jogadores, liga, "Duelos aéreos vencidos (p90)", attribute_chart_z1))

# Data to plot
output_str = f"({ameaça_aérea_5_ranking_value}/{rows_count})"
full_title_ameaça_aérea_5 = f"Duelos aéreos vencidos (p90) {output_str} {highlight_ameaça_aérea_5_value}"
...
def create_player_attributes_plot(tabela_a, jogadores, min_value, max_value):
    ...
    # List of metrics to plot
    metrics_list = [
        'Jogadas de cabeça (p90)', 'Duelos aéreos vencidos no ataque (%)', 
        'Duelos aéreos vencidos no ataque (p90)','Duelos aéreos vencidos (%)',
...
# Calculate min and max values with some padding
min_value_test = min([
min(metrics_ameaça_aérea_1), min(metrics_ameaça_aérea_2), 
min(metrics_ameaça_aérea_3), min(metrics_ameaça_aérea_4),
min(metrics_ameaça_aérea_5)
])  # Add padding of 0.5

max_value_test = max([
max(metrics_ameaça_aérea_1), max(metrics_ameaça_aérea_2), 
max(metrics_ameaça_aérea_3), max(metrics_ameaça_aérea_4),
max(metrics_ameaça_aérea_5)
])  # Add padding of 0.5
...
attribute_chart_per_1 = attribute_chart_per[(attribute_chart_per['Atleta']==jogadores)&
                                            ...
                                            (attribute_chart_per['função']=="Atacante") & (attribute_chart_per['Clube']==equipe)]
#Collecting data to plot
metrics = attribute_chart_1.iloc[:, np.r_[13:18]].reset_index(drop=True)
percent = attribute_chart_per_1.iloc[:, np.r_[33:38]].reset_index(drop=True)
metrics_percent = pd.concat([metrics, percent]).reset_index(drop=True)
#metrics_percent.rename(columns={'Atleta': 'Métricas'}, inplace=True)
metrics_percent = metrics_percent.transpose()
# Rename specific columns while keeping 'Métricas' column unchanged
...
attribute_chart_mean = attribute_chart[(attribute_chart['Liga']==liga)&
                                    (attribute_chart['Temporada']==temporada) & (attribute_chart['função']=="Atacante")]
#Collecting data to plot
metrics = attribute_chart_1.iloc[:, np.r_[3, 13:18]].reset_index(drop=True)
metrics_mean = attribute_chart_mean.iloc[:, np.r_[13:18]]
metrics_mean['Jogadas de cabeça (p90)'] = metrics_mean['Jogadas de cabeça (p90)'].mean()
metrics_mean['Duelos aéreos vencidos no ataque (%)'] = metrics_mean['Duelos aéreos vencidos no ataque (%)'].mean()
metrics_mean['Duelos aéreos vencidos no ataque (p90)'] = metrics_mean['Duelos aéreos vencidos no ataque (p90)'].mean()
...
# Use the dynamically created HTML string in st.markdown
st.markdown("<h3 style='text-align: center; color: deepskyblue; '>Conexão Ofensiva</h3>", unsafe_allow_html=True)
st.markdown(title_html, unsafe_allow_html=True)
...
attribute_chart_z1 = attribute_chart_z[(attribute_chart_z['Liga']==liga) & (attribute_chart_z['Temporada']==temporada) & (attribute_chart_z['função']=="Atacante")]
#Collecting data to plot
metrics = attribute_chart_z1.iloc[:, np.r_[49, 47, 48, 36, 67, 68]].reset_index(drop=True)
metrics_conexão_ofensiva_1 = metrics.iloc[:, 0].tolist()
metrics_conexão_ofensiva_2 = metrics.iloc[:, 1].tolist()
metrics_conexão_ofensiva_3 = metrics.iloc[:, 2].tolist()
metrics_conexão_ofensiva_4 = metrics.iloc[:, 3].tolist()
metrics_conexão_ofensiva_5 = metrics.iloc[:, 4].tolist()
metrics_conexão_ofensiva_6 = metrics.iloc[:, 5].tolist()
metrics_y = [0] * len(metrics_conexão_ofensiva_1)

# The specific data point you want to highlight
highlight = attribute_chart_z1[(attribute_chart_z1['Atleta']==jogadores) & (attribute_chart_z1['Clube']==equipe)]
highlight = highlight.iloc[:, np.r_[49, 47, 48, 36, 67, 68]].reset_index(drop=True)
highlight_conexão_ofensiva_1 = highlight.iloc[:, 0].tolist()
highlight_conexão_ofensiva_2 = highlight.iloc[:, 1].tolist()
highlight_conexão_ofensiva_3 = highlight.iloc[:, 2].tolist()
highlight_conexão_ofensiva_4 = highlight.iloc[:, 3].tolist()
highlight_conexão_ofensiva_5 = highlight.iloc[:, 4].tolist()
highlight_conexão_ofensiva_6 = highlight.iloc[:, 5].tolist()
highlight_y = 0

# Computing the selected player specific values
highlight_conexão_ofensiva_1_value = pd.DataFrame(highlight_conexão_ofensiva_1).reset_index(drop=True)
highlight_conexão_ofensiva_2_value = pd.DataFrame(highlight_conexão_ofensiva_2).reset_index(drop=True)
highlight_conexão_ofensiva_3_value = pd.DataFrame(highlight_conexão_ofensiva_3).reset_index(drop=True)
highlight_conexão_ofensiva_4_value = pd.DataFrame(highlight_conexão_ofensiva_4).reset_index(drop=True)
highlight_conexão_ofensiva_5_value = pd.DataFrame(highlight_conexão_ofensiva_5).reset_index(drop=True)
highlight_conexão_ofensiva_6_value = pd.DataFrame(highlight_conexão_ofensiva_6).reset_index(drop=True)

highlight_conexão_ofensiva_1_value = highlight_conexão_ofensiva_1_value.iat[0,0]
highlight_conexão_ofensiva_2_value = highlight_conexão_ofensiva_2_value.iat[0,0]
highlight_conexão_ofensiva_3_value = highlight_conexão_ofensiva_3_value.iat[0,0]
highlight_conexão_ofensiva_4_value = highlight_conexão_ofensiva_4_value.iat[0,0]
highlight_conexão_ofensiva_5_value = highlight_conexão_ofensiva_5_value.iat[0,0]
highlight_conexão_ofensiva_6_value = highlight_conexão_ofensiva_6_value.iat[0,0]

# Computing the min and max value across all lists using a generator expression
min_value = min(min(lst) for lst in [metrics_conexão_ofensiva_1, metrics_conexão_ofensiva_2, 
                                    metrics_conexão_ofensiva_3, metrics_conexão_ofensiva_4,
                                    metrics_conexão_ofensiva_5, metrics_conexão_ofensiva_6])
min_value = min_value - 0.1
max_value = max(max(lst) for lst in [metrics_conexão_ofensiva_1, metrics_conexão_ofensiva_2, 
                                    metrics_conexão_ofensiva_3, metrics_conexão_ofensiva_4,
                                    metrics_conexão_ofensiva_5, metrics_conexão_ofensiva_6])
max_value = max_value + 0.1
...
# Building the Extended Title"
# Determining player's rank in attribute in league
conexão_ofensiva_1_ranking_value = (get_player_rank(jogadores, liga, "Perdas de posse (p90)", attribute_chart_z1))

# Data to plot
output_str = f"({conexão_ofensiva_1_ranking_value}/{rows_count})"
full_title_conexão_ofensiva_1 = f"Perdas de posse (p90) {output_str} {highlight_conexão_ofensiva_1_value}"

# Building the Extended Title"
# Determining player's rank in attribute in league
conexão_ofensiva_2_ranking_value = (get_player_rank(jogadores, liga, "Retenção de posse sob pressão (p90)", attribute_chart_z1))

# Data to plot
output_str = f"({conexão_ofensiva_2_ranking_value}/{rows_count})"
full_title_conexão_ofensiva_2 = f"Retenção de posse sob pressão (p90) {output_str} {highlight_conexão_ofensiva_2_value}"

# Building the Extended Title"
# Determining player's rank in attribute in league
conexão_ofensiva_3_ranking_value = (get_player_rank(jogadores, liga, "Resistência à pressão (%)", attribute_chart_z1))

# Data to plot
output_str = f"({conexão_ofensiva_3_ranking_value}/{rows_count})"
full_title_conexão_ofensiva_3 = f"Resistência à pressão (%) {output_str} {highlight_conexão_ofensiva_3_value}"

# Building the Extended Title"
# Determining player's rank in attribute in league
conexão_ofensiva_4_ranking_value = (get_player_rank(jogadores, liga, "Duelos aéreos vencidos (%)", attribute_chart_z1))

# Data to plot
output_str = f"({conexão_ofensiva_4_ranking_value}/{rows_count})"
full_title_conexão_ofensiva_4 = f"Duelos aéreos vencidos (%) {output_str} {highlight_conexão_ofensiva_4_value}"

# Building the Extended Title"
# Determining player's rank in attribute in league
conexão_ofensiva_5_ranking_value = (get_player_rank(jogadores, liga, "Recepção de bolas longas (p90)", attribute_chart_z1))

# Data to plot
output_str = f"({conexão_ofensiva_5_ranking_value}/{rows_count})"
full_title_conexão_ofensiva_5 = f"Recepção de bolas longas (p90) {output_str} {highlight_conexão_ofensiva_5_value}"

# Building the Extended Title"
# Determining player's rank in attribute in league
conexão_ofensiva_6_ranking_value = (get_player_rank(jogadores, liga, "Conexões ofensivas (p90)", attribute_chart_z1))

# Data to plot
output_str = f"({conexão_ofensiva_6_ranking_value}/{rows_count})"
full_title_conexão_ofensiva_6 = f"Conexões ofensivas (p90) {output_str} {highlight_conexão_ofensiva_6_value}"
...
def create_player_attributes_plot(tabela_a, jogadores, min_value, max_value):
    ...
    """
    # List of metrics to plot
    metrics_list = ['Perdas de posse (p90)', 'Retenção de posse sob pressão (p90)',
                    'Resistência à pressão (%)', 'Duelos aéreos vencidos (%)', 
                    'Recepção de bolas longas (p90)', 'Conexões ofensivas (p90)'
    ]
...
# Calculate min and max values with some padding
min_value_test = min([
min(metrics_conexão_ofensiva_1), min(metrics_conexão_ofensiva_2), 
min(metrics_conexão_ofensiva_3), min(metrics_conexão_ofensiva_4),
min(metrics_conexão_ofensiva_5), min(metrics_conexão_ofensiva_6)
])  # Add padding of 0.5

max_value_test = max([
max(metrics_conexão_ofensiva_1), max(metrics_conexão_ofensiva_2), 
max(metrics_conexão_ofensiva_3), max(metrics_conexão_ofensiva_4),
max(metrics_conexão_ofensiva_5), max(metrics_conexão_ofensiva_6)
])  # Add padding of 0.5
...
attribute_chart_per_1 = attribute_chart_per[(attribute_chart_per['Atleta']==jogadores)&
                                            ...
                                            (attribute_chart_per['função']=="Atacante") & (attribute_chart_per['Clube']==equipe)]
#Collecting data to plot
metrics = attribute_chart_1.iloc[:, np.r_[29, 27, 28, 16, 47, 48]].reset_index(drop=True)
percent = attribute_chart_per_1.iloc[:, np.r_[49, 47, 48, 36, 67, 68]].reset_index(drop=True)
metrics_percent = pd.concat([metrics, percent]).reset_index(drop=True)
#metrics_percent.rename(columns={'Atleta': 'Métricas'}, inplace=True)
metrics_percent = metrics_percent.transpose()
# Rename specific columns while keeping 'Métricas' column unchanged
...
attribute_chart_mean = attribute_chart[(attribute_chart['Liga']==liga)&
                                    (attribute_chart['Temporada']==temporada) & (attribute_chart['função']=="Atacante")]
#Collecting data to plot
metrics = attribute_chart_1.iloc[:, np.r_[3, 29, 27, 28, 16, 47, 48]].reset_index(drop=True)
metrics_mean = attribute_chart_mean.iloc[:, np.r_[29, 27, 28, 16, 47, 48]]
...
metrics_mean['Duelos aéreos vencidos (%)'] = metrics_mean['Duelos aéreos vencidos (%)'].mean()
metrics_mean['Recepção de bolas longas (p90)'] = metrics_mean['Recepção de bolas longas (p90)'].mean()
metrics_mean['Conexões ofensivas (p90)'] = metrics_mean['Conexões ofensivas (p90)'].mean()
...
attribute_chart_per = pd.read_csv('patch_code_per.csv')
attribute_chart_1 = attribute_chart[(attribute_chart['Atleta']==jogadores)&
                                    (attribute_chart['Liga']==liga)&(attribute_chart['Temporada']==temporada) & 
                                    (attribute_chart['função']=="Atacante") & (attribute_chart['Clube']==equipe)]
attribute_chart_per_1 = attribute_chart_per[(attribute_chart_per['Atleta']==jogadores)&
                                            (attribute_chart_per['Liga']==liga)&(attribute_chart_per['Temporada']==temporada) & 
                                            (attribute_chart_per['função']=="Atacante") & (attribute_chart_per['Clube']==equipe)]
#Collecting data to plot
...
# Use the dynamically created HTML string in st.markdown
st.markdown("<h3 style='text-align: center; color: deepskyblue; '>Oportunismo</h3>", unsafe_allow_html=True)
st.markdown(title_html, unsafe_allow_html=True)

attribute_chart_z = attribute_chart_z.rename(columns={'xG_box_touch':'xG (pToque na área)', 
                                                      'goals_box_touch':'Gols (pToque na área)'
                                                      })

# Collecting data
attribute_chart_z1 = attribute_chart_z[(attribute_chart_z['Liga']==liga) & (attribute_chart_z['Temporada']==temporada) & (attribute_chart_z['função']=="Atacante")]
#Collecting data to plot
metrics = attribute_chart_z1.iloc[:, np.r_[80, 81, 57, 39]].reset_index(drop=True)
...
metrics_y = [0] * len(metrics_oportunismo_1)

# The specific data point you want to highlight
highlight = attribute_chart_z1[(attribute_chart_z1['Atleta']==jogadores) & (attribute_chart_z1['Clube']==equipe)]
highlight = highlight.iloc[:, np.r_[80, 81, 57, 39]].reset_index(drop=True)
...
# Building the Extended Title"
# Determining player's rank in attribute in league
oportunismo_1_ranking_value = (get_player_rank(jogadores, liga, "xG (pToque na área)", attribute_chart_z1))

# Data to plot
output_str = f"({oportunismo_1_ranking_value}/{rows_count})"
full_title_oportunismo_1 = f"xG (pToque na área) {output_str} {highlight_oportunismo_1_value}"

# Building the Extended Title"
# Determining player's rank in attribute in league
oportunismo_2_ranking_value = (get_player_rank(jogadores, liga, "Gols (pToque na área)", attribute_chart_z1))

# Data to plot
output_str = f"({oportunismo_2_ranking_value}/{rows_count})"
full_title_oportunismo_2 = f"Gols (pToque na área) {output_str} {highlight_oportunismo_2_value}"

# Building the Extended Title"
# Determining player's rank in attribute in league
oportunismo_3_ranking_value = (get_player_rank(jogadores, liga, "xG (pFinalização)", attribute_chart_z1))

# Data to plot
output_str = f"({oportunismo_3_ranking_value}/{rows_count})"
full_title_oportunismo_3 = f"xG (pFinalização) {output_str} {highlight_oportunismo_3_value}"

# Building the Extended Title"
# Determining player's rank in attribute in league
oportunismo_4_ranking_value = (get_player_rank(jogadores, liga, "xG (p90)", attribute_chart_z1))

# Data to plot
output_str = f"({oportunismo_4_ranking_value}/{rows_count})"
full_title_oportunismo_4 = f"xG (p90) {output_str} {highlight_oportunismo_4_value}"
...
def create_player_attributes_plot(tabela_a, jogadores, min_value, max_value):
    ...
    # List of metrics to plot
    metrics_list = [
        'xG (pToque na área)', 'Gols (pToque na área)', 
        'Conversão de finalizações (%)','Gols (p90)'
    ]
...
# Calculate min and max values with some padding
min_value_test = min([
min(metrics_oportunismo_1), min(metrics_oportunismo_2), 
min(metrics_oportunismo_3), min(metrics_oportunismo_4),
])  # Add padding of 0.5

max_value_test = max([
max(metrics_oportunismo_1), max(metrics_oportunismo_2), 
max(metrics_oportunismo_3), max(metrics_oportunismo_4),
])  # Add padding of 0.5
...
st.markdown("<h3 style='text-align: center; color: blue; '>Percentis das Métricas do Jogador na Liga em 2024</h3>", unsafe_allow_html=True)
attribute_chart = pd.read_csv("patch_code.csv")
attribute_chart = attribute_chart.rename(columns={'xG_box_touch':'xG (pToque na área)', 
                                                        'goals_box_touch':'Gols (pToque na área)'})
attribute_chart_per = pd.read_csv('patch_code_per.csv')
attribute_chart_per = attribute_chart_per.rename(columns={'xG_box_touch':'xG (pToque na área)', 
                                                        'goals_box_touch':'Gols (pToque na área)'})
...
attribute_chart_per_1 = attribute_chart_per[(attribute_chart_per['Atleta']==jogadores)&
                                            ...
                                            (attribute_chart_per['função']=="Atacante") & (attribute_chart_per['Clube']==equipe)]
#Collecting data to plot
metrics = attribute_chart_1.iloc[:, np.r_[60, 61, 37, 19]].reset_index(drop=True)
percent = attribute_chart_per_1.iloc[:, np.r_[80, 81, 57, 39]].reset_index(drop=True)
metrics_percent = pd.concat([metrics, percent]).reset_index(drop=True)
metrics_percent = metrics_percent.transpose()
metrics_percent = metrics_percent.rename(columns={
    metrics_percent.columns[0]: f'Métricas',
...
attribute_chart_mean = attribute_chart[(attribute_chart['Liga']==liga)&
                                    (attribute_chart['Temporada']==temporada) & (attribute_chart['função']=="Atacante")]
#Collecting data to plot
metrics = attribute_chart_1.iloc[:, np.r_[3, 60, 61, 37, 19]].reset_index(drop=True)
metrics_mean = attribute_chart_mean.iloc[:, np.r_[60, 61, 37, 19]]
metrics_mean['xG (pToque na área)'] = metrics_mean['xG (pToque na área)'].mean()
metrics_mean['Gols (pToque na área)'] = metrics_mean['Gols (pToque na área)'].mean()
