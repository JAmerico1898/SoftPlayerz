...
Participação_Extremo_Charts_1 = Extremo_Charts_1.copy()

metrics = Participação_Extremo_Charts_1.iloc[:, np.r_[3, 72:74, 31, 74]].reset_index(drop=True)
## parameter names
...
####################################################################################################                            
####################################################################################################                            
métricas_pressão_linha_alta = ['Contra-pressão (p90)', 
                                'Interceptações (p90)', 
                                'Recuperações linha alta (p90)', 
                                'Intensidade defensiva (p90)'
]

#Plotar Primeiro Gráfico - Radar de Percentis do Jogador na liga:
st.markdown("---")
st.markdown("<h3 style='text-align: center; color: blue; '>Percentis e Métricas de<br>Pressão na Linha Alta</h3>", unsafe_allow_html=True)

Pressão_Linha_Alta_Extremo_Charts = Extremo_Charts_1.copy()

#Collecting data to plot
metrics = Pressão_Linha_Alta_Extremo_Charts.iloc[:, np.r_[3, 70, 69, 82:84]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
jogador_1_scores = jogador_1_scores[
((jogador_1_scores['Atleta'] == jogador_1) & (jogador_1_scores['Clube'] == equipe_1) & (jogador_1_scores['Temporada'] == temporada_1))]
jogador_1_scores = jogador_1_scores.iloc[:, np.r_[3, 50, 49, 62:64]].reset_index(drop=True)
jogador_1_scores = jogador_1_scores.round(decimals=2)
jogador_1_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_1_percs = jogador_1_percs[
((jogador_1_percs['Atleta'] == jogador_1) & (jogador_1_percs['Clube'] == equipe_1)  & (jogador_1_percs['Temporada'] == temporada_1))]
jogador_1_percs = jogador_1_percs.iloc[:, np.r_[3, 70, 69, 82:84]].reset_index(drop=True)
jogador_1_percs = jogador_1_percs.round(decimals=0)
jogador_1_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_1 + "_percent"
jogador_1_percs.iloc[0, 0] = jogador_1 + "_percent"
...
jogador_1_scores = jogador_1_scores.drop(jogador_1_scores.index[0])  # Drop the old header row
jogador_1_scores = jogador_1_scores.reset_index(drop=True)
jogador_1_scores.insert(0, 'Métricas', métricas_pressão_linha_alta)
...
jogador_2_scores = jogador_2_scores[
((jogador_2_scores['Atleta'] == jogador_2) & (jogador_2_scores['Clube'] == equipe_2) & (jogador_2_scores['Temporada'] == temporada_2))]
jogador_2_scores = jogador_2_scores.iloc[:, np.r_[3, 50, 49, 62:64]].reset_index(drop=True)
jogador_2_scores = jogador_2_scores.round(decimals=2)
jogador_2_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_2_percs = jogador_2_percs[
((jogador_2_percs['Atleta'] == jogador_2) & (jogador_2_percs['Clube'] == equipe_2)  & (jogador_2_percs['Temporada'] == temporada_2))]
jogador_2_percs = jogador_2_percs.iloc[:, np.r_[3, 70, 69, 82:84]].reset_index(drop=True)
jogador_2_percs = jogador_2_percs.round(decimals=0)
jogador_2_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_2 + "_percent"
jogador_2_percs.iloc[0, 0] = jogador_2 + "_percent"
...
jogador_2_scores = jogador_2_scores.drop(jogador_2_scores.index[0])  # Drop the old header row
jogador_2_scores = jogador_2_scores.reset_index(drop=True)
jogador_2_scores.insert(0, 'Métricas', métricas_pressão_linha_alta)
...
métricas_impacto_passe = ['Passes criativos (p90)', 
                            'xT Passes no último terço (p90)', 
...
#Plotar Primeiro Gráfico - Radar de Percentis do Jogador na liga:
st.markdown("---")
st.markdown("<h3 style='text-align: center; color: blue; '>Percentis das Métricas de<br>Impacto do Passe</h3>", unsafe_allow_html=True)

Impacto_Passe_Extremo_Charts = Extremo_Charts_1.copy()

#Collecting data to plot
metrics = Impacto_Passe_Extremo_Charts.iloc[:, np.r_[3, 75:80]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
jogador_1_scores = jogador_1_scores[
((jogador_1_scores['Atleta'] == jogador_1) & (jogador_1_scores['Clube'] == equipe_1) & (jogador_1_scores['Temporada'] == temporada_1))]
jogador_1_scores = jogador_1_scores.iloc[:, np.r_[3, 55:60]].reset_index(drop=True)
jogador_1_scores = jogador_1_scores.round(decimals=2)
jogador_1_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_1_percs = jogador_1_percs[
((jogador_1_percs['Atleta'] == jogador_1) & (jogador_1_percs['Clube'] == equipe_1)  & (jogador_1_percs['Temporada'] == temporada_1))]
jogador_1_percs = jogador_1_percs.iloc[:, np.r_[3, 75:80]].reset_index(drop=True)
jogador_1_percs = jogador_1_percs.round(decimals=0)
jogador_1_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_1 + "_percent"
jogador_1_percs.iloc[0, 0] = jogador_1 + "_percent"
...
jogador_1_scores = jogador_1_scores.drop(jogador_1_scores.index[0])  # Drop the old header row
jogador_1_scores = jogador_1_scores.reset_index(drop=True)
jogador_1_scores.insert(0, 'Métricas', métricas_impacto_passe)
...
jogador_2_scores = jogador_2_scores[
((jogador_2_scores['Atleta'] == jogador_2) & (jogador_2_scores['Clube'] == equipe_2) & (jogador_2_scores['Temporada'] == temporada_2))]
jogador_2_scores = jogador_2_scores.iloc[:, np.r_[3, 55:60]].reset_index(drop=True)
jogador_2_scores = jogador_2_scores.round(decimals=2)
jogador_2_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_2_percs = jogador_2_percs[
((jogador_2_percs['Atleta'] == jogador_2) & (jogador_2_percs['Clube'] == equipe_2)  & (jogador_2_percs['Temporada'] == temporada_2))]
jogador_2_percs = jogador_2_percs.iloc[:, np.r_[3, 75:80]].reset_index(drop=True)
jogador_2_percs = jogador_2_percs.round(decimals=0)
jogador_2_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_2 + "_percent"
jogador_2_percs.iloc[0, 0] = jogador_2 + "_percent"
...
jogador_2_scores = jogador_2_scores.drop(jogador_2_scores.index[0])  # Drop the old header row
jogador_2_scores = jogador_2_scores.reset_index(drop=True)
jogador_2_scores.insert(0, 'Métricas', métricas_impacto_passe)
...
#Plotar Primeiro Gráfico - Radar de Percentis do Jogador na liga:
st.markdown("---")
st.markdown("<h3 style='text-align: center; color: blue; '>Percentis e Métricas de<br>Movimentação Ofensiva</h3>", unsafe_allow_html=True)

Movimentação_Ofensiva_Extremo_Charts = Extremo_Charts_1.copy()

#Collecting data to plot
metrics = Movimentação_Ofensiva_Extremo_Charts.iloc[:, np.r_[3, 38, 92:94, 41]].reset_index(drop=True)
...
jogador_1_scores = jogador_1_scores[
((jogador_1_scores['Atleta'] == jogador_1) & (jogador_1_scores['Clube'] == equipe_1) & (jogador_1_scores['Temporada'] == temporada_1))]
jogador_1_scores = jogador_1_scores.iloc[:, np.r_[3, 18, 72:74, 21]].reset_index(drop=True)
jogador_1_scores = jogador_1_scores.round(decimals=2)
jogador_1_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_1_percs = jogador_1_percs[
((jogador_1_percs['Atleta'] == jogador_1) & (jogador_1_percs['Clube'] == equipe_1)  & (jogador_1_percs['Temporada'] == temporada_1))]
jogador_1_percs = jogador_1_percs.iloc[:, np.r_[3, 38, 92:94, 41]].reset_index(drop=True)
jogador_1_percs = jogador_1_percs.round(decimals=0)
jogador_1_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_1 + "_percent"
jogador_1_percs.iloc[0, 0] = jogador_1 + "_percent"
...
jogador_1_scores = jogador_1_scores.drop(jogador_1_scores.index[0])  # Drop the old header row
jogador_1_scores = jogador_1_scores.reset_index(drop=True)
jogador_1_scores.insert(0, 'Métricas', métricas_movimentação_ofensiva)
...
jogador_2_scores = jogador_2_scores[
((jogador_2_scores['Atleta'] == jogador_2) & (jogador_2_scores['Clube'] == equipe_2) & (jogador_2_scores['Temporada'] == temporada_2))]
jogador_2_scores = jogador_2_scores.iloc[:, np.r_[3, 18, 72:74, 21]].reset_index(drop=True)
jogador_2_scores = jogador_2_scores.round(decimals=2)
jogador_2_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_2_percs = jogador_2_percs[
((jogador_2_percs['Atleta'] == jogador_2) & (jogador_2_percs['Clube'] == equipe_2)  & (jogador_2_percs['Temporada'] == temporada_2))]
jogador_2_percs = jogador_2_percs.iloc[:, np.r_[3, 38, 92:94, 41]].reset_index(drop=True)
jogador_2_percs = jogador_2_percs.round(decimals=0)
jogador_2_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_2 + "_percent"
jogador_2_percs.iloc[0, 0] = jogador_2 + "_percent"
...
jogador_2_scores = jogador_2_scores.drop(jogador_2_scores.index[0])  # Drop the old header row
jogador_2_scores = jogador_2_scores.reset_index(drop=True)
jogador_2_scores.insert(0, 'Métricas', métricas_movimentação_ofensiva)
...
métricas_drible = ['Resistência à pressão (%)', 
                    'xG Dribles (p90)', 
                    'xT Dribles (p90)', 
...
#Plotar Primeiro Gráfico - Radar de Percentis do Jogador na liga:
st.markdown("---")
st.markdown("<h3 style='text-align: center; color: blue; '>Percentis e Métricas de<br>Drible</h3>", unsafe_allow_html=True)

Drible_Extremo_Charts = Extremo_Charts_1.copy()

#Collecting data to plot
metrics = Drible_Extremo_Charts.iloc[:, np.r_[3, 48, 54:57]].reset_index(drop=True)
...
jogador_1_scores = jogador_1_scores[
((jogador_1_scores['Atleta'] == jogador_1) & (jogador_1_scores['Clube'] == equipe_1) & (jogador_1_scores['Temporada'] == temporada_1))]
jogador_1_scores = jogador_1_scores.iloc[:, np.r_[3, 28, 34:37]].reset_index(drop=True)
jogador_1_scores = jogador_1_scores.round(decimals=2)
jogador_1_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_1_percs = jogador_1_percs[
((jogador_1_percs['Atleta'] == jogador_1) & (jogador_1_percs['Clube'] == equipe_1)  & (jogador_1_percs['Temporada'] == temporada_1))]
jogador_1_percs = jogador_1_percs.iloc[:, np.r_[3, 48, 54:57]].reset_index(drop=True)
jogador_1_percs = jogador_1_percs.round(decimals=0)
jogador_1_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_1 + "_percent"
jogador_1_percs.iloc[0, 0] = jogador_1 + "_percent"
...
jogador_1_scores = jogador_1_scores.drop(jogador_1_scores.index[0])  # Drop the old header row
jogador_1_scores = jogador_1_scores.reset_index(drop=True)
jogador_1_scores.insert(0, 'Métricas', métricas_drible)
...
jogador_2_scores = jogador_2_scores[
((jogador_2_scores['Atleta'] == jogador_2) & (jogador_2_scores['Clube'] == equipe_2) & (jogador_2_scores['Temporada'] == temporada_2))]
jogador_2_scores = jogador_2_scores.iloc[:, np.r_[3, 28, 34:37]].reset_index(drop=True)
jogador_2_scores = jogador_2_scores.round(decimals=2)
jogador_2_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_2_percs = jogador_2_percs[
((jogador_2_percs['Atleta'] == jogador_2) & (jogador_2_percs['Clube'] == equipe_2)  & (jogador_2_percs['Temporada'] == temporada_2))]
jogador_2_percs = jogador_2_percs.iloc[:, np.r_[3, 48, 54:57]].reset_index(drop=True)
jogador_2_percs = jogador_2_percs.round(decimals=0)
jogador_2_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_2 + "_percent"
jogador_2_percs.iloc[0, 0] = jogador_2 + "_percent"
...
jogador_2_scores = jogador_2_scores.drop(jogador_2_scores.index[0])  # Drop the old header row
jogador_2_scores = jogador_2_scores.reset_index(drop=True)
jogador_2_scores.insert(0, 'Métricas', métricas_drible)
...
métricas_efetividade = ['xG (pFinalização)', 
                        '(xG + xA) (p100 toques)', 
                        'Posses recuperadas (pPosse adversária)', 
                        'Perdas de posse (pRecepção na linha baixa)', 
                        'xG Chain (pPosse)', 
                        'xT Conduções (p100 Recepções)', 
                        'xT Passes (p100 Recepções)'
]

#Plotar Primeiro Gráfico - Radar de Percentis do Jogador na liga:
st.markdown("---")
st.markdown("<h3 style='text-align: center; color: blue; '>Percentis e Métricas de<br>Efetividade</h3>", unsafe_allow_html=True)

Efetividade_Extremo_Charts = Extremo_Charts_1.copy()

#Collecting data to plot
metrics = Efetividade_Extremo_Charts.iloc[:, np.r_[3, 57:64]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
jogador_1_scores = jogador_1_scores[
((jogador_1_scores['Atleta'] == jogador_1) & (jogador_1_scores['Clube'] == equipe_1) & (jogador_1_scores['Temporada'] == temporada_1))]
jogador_1_scores = jogador_1_scores.iloc[:, np.r_[3, 37:44]].reset_index(drop=True)
jogador_1_scores = jogador_1_scores.round(decimals=2)
jogador_1_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_1_percs = jogador_1_percs[
((jogador_1_percs['Atleta'] == jogador_1) & (jogador_1_percs['Clube'] == equipe_1)  & (jogador_1_percs['Temporada'] == temporada_1))]
jogador_1_percs = jogador_1_percs.iloc[:, np.r_[3, 57:64]].reset_index(drop=True)
jogador_1_percs = jogador_1_percs.round(decimals=0)
jogador_1_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_1 + "_percent"
jogador_1_percs.iloc[0, 0] = jogador_1 + "_percent"
...
jogador_1_scores = jogador_1_scores.drop(jogador_1_scores.index[0])  # Drop the old header row
jogador_1_scores = jogador_1_scores.reset_index(drop=True)
jogador_1_scores.insert(0, 'Métricas', métricas_efetividade)
...
jogador_2_scores = jogador_2_scores[
((jogador_2_scores['Atleta'] == jogador_2) & (jogador_2_scores['Clube'] == equipe_2) & (jogador_2_scores['Temporada'] == temporada_2))]
jogador_2_scores = jogador_2_scores.iloc[:, np.r_[3, 37:44]].reset_index(drop=True)
jogador_2_scores = jogador_2_scores.round(decimals=2)
jogador_2_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_2_percs = jogador_2_percs[
((jogador_2_percs['Atleta'] == jogador_2) & (jogador_2_percs['Clube'] == equipe_2)  & (jogador_2_percs['Temporada'] == temporada_2))]
jogador_2_percs = jogador_2_percs.iloc[:, np.r_[3, 57:64]].reset_index(drop=True)
jogador_2_percs = jogador_2_percs.round(decimals=0)
jogador_2_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_2 + "_percent"
jogador_2_percs.iloc[0, 0] = jogador_2 + "_percent"
...
jogador_2_scores = jogador_2_scores.drop(jogador_2_scores.index[0])  # Drop the old header row
jogador_2_scores = jogador_2_scores.reset_index(drop=True)
jogador_2_scores.insert(0, 'Métricas', métricas_efetividade)
...
métricas_criação_oportunidades = ['xG Criado (p90)', 
                                    'Passes chave (p90)', 
...
#Plotar Primeiro Gráfico - Radar de Percentis do Jogador na liga:
st.markdown("---")
st.markdown("<h3 style='text-align: center; color: blue; '>Percentis e Métricas de<br>Criação de Oportunidades</h3>", unsafe_allow_html=True)

Criação_Oportunidades_Extremo_Charts = Extremo_Charts_1.copy()

#Collecting data to plot
metrics = Criação_Oportunidades_Extremo_Charts.iloc[:, np.r_[3, 86, 88:92]].reset_index(drop=True)
...
jogador_1_scores = jogador_1_scores[
((jogador_1_scores['Atleta'] == jogador_1) & (jogador_1_scores['Clube'] == equipe_1) & (jogador_1_scores['Temporada'] == temporada_1))]
jogador_1_scores = jogador_1_scores.iloc[:, np.r_[3, 66, 68:72]].reset_index(drop=True)
jogador_1_scores = jogador_1_scores.round(decimals=2)
jogador_1_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_1_percs = jogador_1_percs[
((jogador_1_percs['Atleta'] == jogador_1) & (jogador_1_percs['Clube'] == equipe_1)  & (jogador_1_percs['Temporada'] == temporada_1))]
jogador_1_percs = jogador_1_percs.iloc[:, np.r_[3, 86, 88:92]].reset_index(drop=True)
jogador_1_percs = jogador_1_percs.round(decimals=0)
jogador_1_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_1 + "_percent"
jogador_1_percs.iloc[0, 0] = jogador_1 + "_percent"
...
jogador_1_scores = jogador_1_scores.drop(jogador_1_scores.index[0])  # Drop the old header row
jogador_1_scores = jogador_1_scores.reset_index(drop=True)
jogador_1_scores.insert(0, 'Métricas', métricas_criação_oportunidades)
...
jogador_2_scores = jogador_2_scores[
((jogador_2_scores['Atleta'] == jogador_2) & (jogador_2_scores['Clube'] == equipe_2) & (jogador_2_scores['Temporada'] == temporada_2))]
jogador_2_scores = jogador_2_scores.iloc[:, np.r_[3, 66, 68:72]].reset_index(drop=True)
jogador_2_scores = jogador_2_scores.round(decimals=2)
jogador_2_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_2_percs = jogador_2_percs[
((jogador_2_percs['Atleta'] == jogador_2) & (jogador_2_percs['Clube'] == equipe_2)  & (jogador_2_percs['Temporada'] == temporada_2))]
jogador_2_percs = jogador_2_percs.iloc[:, np.r_[3, 86, 88:92]].reset_index(drop=True)
jogador_2_percs = jogador_2_percs.round(decimals=0)
jogador_2_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_2 + "_percent"
jogador_2_percs.iloc[0, 0] = jogador_2 + "_percent"
...
jogador_2_scores = jogador_2_scores.drop(jogador_2_scores.index[0])  # Drop the old header row
jogador_2_scores = jogador_2_scores.reset_index(drop=True)
jogador_2_scores.insert(0, 'Métricas', métricas_criação_oportunidades)
...
métricas_ameaça_ofensiva = ['Recepções na área (p90)', 
                            'xG (p90)', 
                            'Gols (p90)', 
                            'Entradas na área (p90)',
                            'Toques na área (p90)'
...
#Plotar Primeiro Gráfico - Radar de Percentis do Jogador na liga:
st.markdown("---")
st.markdown("<h3 style='text-align: center; color: blue; '>Percentis e Métricas de<br>Ameaça Ofensiva</h3>", unsafe_allow_html=True)

Ameaça_Ofensiva_Extremo_Charts = Extremo_Charts_1.copy()

#Collecting data to plot
metrics = Ameaça_Ofensiva_Extremo_Charts.iloc[:, np.r_[3, 38:43]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
jogador_1_scores = jogador_1_scores[
((jogador_1_scores['Atleta'] == jogador_1) & (jogador_1_scores['Clube'] == equipe_1) & (jogador_1_scores['Temporada'] == temporada_1))]
jogador_1_scores = jogador_1_scores.iloc[:, np.r_[3, 18:23]].reset_index(drop=True)
jogador_1_scores = jogador_1_scores.round(decimals=2)
jogador_1_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_1_percs = jogador_1_percs[
((jogador_1_percs['Atleta'] == jogador_1) & (jogador_1_percs['Clube'] == equipe_1)  & (jogador_1_percs['Temporada'] == temporada_1))]
jogador_1_percs = jogador_1_percs.iloc[:, np.r_[3, 38:43]].reset_index(drop=True)
jogador_1_percs = jogador_1_percs.round(decimals=0)
jogador_1_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_1 + "_percent"
jogador_1_percs.iloc[0, 0] = jogador_1 + "_percent"
...
jogador_1_scores = jogador_1_scores.drop(jogador_1_scores.index[0])  # Drop the old header row
jogador_1_scores = jogador_1_scores.reset_index(drop=True)
jogador_1_scores.insert(0, 'Métricas', métricas_ameaça_ofensiva)
...
jogador_2_scores = jogador_2_scores[
((jogador_2_scores['Atleta'] == jogador_2) & (jogador_2_scores['Clube'] == equipe_2) & (jogador_2_scores['Temporada'] == temporada_2))]
jogador_2_scores = jogador_2_scores.iloc[:, np.r_[3, 18:23]].reset_index(drop=True)
jogador_2_scores = jogador_2_scores.round(decimals=2)
jogador_2_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_2_percs = jogador_2_percs[
((jogador_2_percs['Atleta'] == jogador_2) & (jogador_2_percs['Clube'] == equipe_2)  & (jogador_2_percs['Temporada'] == temporada_2))]
jogador_2_percs = jogador_2_percs.iloc[:, np.r_[3, 38:43]].reset_index(drop=True)
jogador_2_percs = jogador_2_percs.round(decimals=0)
jogador_2_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_2 + "_percent"
jogador_2_percs.iloc[0, 0] = jogador_2 + "_percent"
...
jogador_2_scores = jogador_2_scores.drop(jogador_2_scores.index[0])  # Drop the old header row
jogador_2_scores = jogador_2_scores.reset_index(drop=True)
jogador_2_scores.insert(0, 'Métricas', métricas_ameaça_ofensiva)
...
#Plotar Primeiro Gráfico - Radar de Percentis do Jogador na liga:
st.markdown("---")
st.markdown("<h3 style='text-align: center; color: blue; '>Percentis e Métricas de<br>Finalização</h3>", unsafe_allow_html=True)

Finalização_Extremo_Charts = Extremo_Charts_1.copy()

#Collecting data to plot
metrics = Finalização_Extremo_Charts.iloc[:, np.r_[3, 64:67, 40]].reset_index(drop=True)
...
jogador_1_scores = jogador_1_scores[
((jogador_1_scores['Atleta'] == jogador_1) & (jogador_1_scores['Clube'] == equipe_1) & (jogador_1_scores['Temporada'] == temporada_1))]
jogador_1_scores = jogador_1_scores.iloc[:, np.r_[3, 44:47, 20]].reset_index(drop=True)
jogador_1_scores = jogador_1_scores.round(decimals=2)
jogador_1_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_1_percs = jogador_1_percs[
((jogador_1_percs['Atleta'] == jogador_1) & (jogador_1_percs['Clube'] == equipe_1)  & (jogador_1_percs['Temporada'] == temporada_1))]
jogador_1_percs = jogador_1_percs.iloc[:, np.r_[3, 64:67, 40]].reset_index(drop=True)
jogador_1_percs = jogador_1_percs.round(decimals=0)
jogador_1_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_1 + "_percent"
jogador_1_percs.iloc[0, 0] = jogador_1 + "_percent"
...
jogador_1_scores = jogador_1_scores.drop(jogador_1_scores.index[0])  # Drop the old header row
jogador_1_scores = jogador_1_scores.reset_index(drop=True)
jogador_1_scores.insert(0, 'Métricas', métricas_finalização)
...
jogador_2_scores = jogador_2_scores[
((jogador_2_scores['Atleta'] == jogador_2) & (jogador_2_scores['Clube'] == equipe_2) & (jogador_2_scores['Temporada'] == temporada_2))]
jogador_2_scores = jogador_2_scores.iloc[:, np.r_[3, 44:47, 20]].reset_index(drop=True)
jogador_2_scores = jogador_2_scores.round(decimals=2)
jogador_2_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_2_percs = jogador_2_percs[
((jogador_2_percs['Atleta'] == jogador_2) & (jogador_2_percs['Clube'] == equipe_2)  & (jogador_2_percs['Temporada'] == temporada_2))]
jogador_2_percs = jogador_2_percs.iloc[:, np.r_[3, 64:67, 40]].reset_index(drop=True)
jogador_2_percs = jogador_2_percs.round(decimals=0)
jogador_2_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_2 + "_percent"
jogador_2_percs.iloc[0, 0] = jogador_2 + "_percent"
...
jogador_2_scores = jogador_2_scores.drop(jogador_2_scores.index[0])  # Drop the old header row
jogador_2_scores = jogador_2_scores.reset_index(drop=True)
jogador_2_scores.insert(0, 'Métricas', métricas_finalização)
