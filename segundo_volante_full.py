atributos_segundo_volante = ['Participação', 'Intensidade defensiva', 'Inteligência defensiva', 
                        'Transição ofensiva', 'Impacto do passe', 'Drible', 'Criação de oportunidades']
...
rows_count = attribute_chart_z1[(attribute_chart_z1['Liga'] == liga) & (attribute_chart_z1['Posição'] == "Segundo Volante")].shape[0]
...
função = attribute_chart.iat[0, 8]
