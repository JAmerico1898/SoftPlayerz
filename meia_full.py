atributos_meia = ['Participação', 'Pressão na linha alta', 'Impacto do passe', 
            'Criação de oportunidades', 'Drible', 'Efetividade',
            'Ameaça ofensiva']
...
rows_count = attribute_chart_z1[(attribute_chart_z1['Liga'] == liga) & (attribute_chart_z1['Posição'] == "Meia")].shape[0]
...
attribute_chart_1 = attribute_chart[(attribute_chart['Atleta']==jogadores)&
                                    ...
                                    (attribute_chart['função']=="Meio Campo")&
...
attribute_chart_per_1 = attribute_chart_per[(attribute_chart_per['Atleta']==jogadores)&
                                            ...
                                            (attribute_chart_per['função']=="Meio Campo") &
...
max_value_test = max([
max(metrics_dribles_1), max(metrics_dribles_2), 
max(metrics_dribles_3), max(metrics_dribles_4),
])  # Add padding of 0.5
