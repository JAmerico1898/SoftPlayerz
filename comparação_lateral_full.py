...
Participação_Lateral_Charts_1 = Lateral_Charts_1.copy()

metrics = Participação_Lateral_Charts_1.iloc[:, np.r_[3, 72:74, 31, 74]].reset_index(drop=True)
## parameter names
...
Intensidade_Defensiva_Lateral_Charts = Lateral_Charts_1.copy()

#Collecting data to plot
metrics = Intensidade_Defensiva_Lateral_Charts.iloc[:, np.r_[3, 29:33]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
Inteligência_Defensiva_Lateral_Charts = Lateral_Charts_1.copy()

#Collecting data to plot
metrics = Inteligência_Defensiva_Lateral_Charts.iloc[:, np.r_[3, 69:72]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
Controle_Espaço_Lateral_Charts = Lateral_Charts_1.copy()

#Collecting data to plot
metrics = Controle_Espaço_Lateral_Charts.iloc[:, np.r_[3, 94, 96:98]].reset_index(drop=True)
...
Controle_Defensivo_Lateral_Charts = Lateral_Charts_1.copy()

#Collecting data to plot
metrics = Controle_Defensivo_Lateral_Charts.iloc[:, np.r_[3, 43:47]].reset_index(drop=True)
...
transição_ofensiva_Lateral_Charts = Lateral_Charts_1.copy()

#Collecting data to plot
metrics = transição_ofensiva_Lateral_Charts.iloc[:, np.r_[3, 84, 77, 85]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
Impacto_Passe_Lateral_Charts = Lateral_Charts_1.copy()

#Collecting data to plot
metrics = Impacto_Passe_Lateral_Charts.iloc[:, np.r_[3, 75:80]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
Movimentação_Ofensiva_Lateral_Charts = Lateral_Charts_1.copy()

#Collecting data to plot
metrics = Movimentação_Ofensiva_Lateral_Charts.iloc[:, np.r_[3, 38, 92:94, 41]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
Criação_Oportunidades_Lateral_Charts = Lateral_Charts_1.copy()

#Collecting data to plot
metrics = Criação_Oportunidades_Lateral_Charts.iloc[:, np.r_[3, 86, 88:92]].reset_index(drop=True)
