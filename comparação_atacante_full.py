...
Participação_Atacante_Charts_1 = Atacante_Charts_1.copy()

metrics = Participação_Atacante_Charts_1.iloc[:, np.r_[3, 72:74, 31, 74]].reset_index(drop=True)
## parameter names
...
Pressão_Linha_Alta_Atacante_Charts = Atacante_Charts_1.copy()

#Collecting data to plot
metrics = Pressão_Linha_Alta_Atacante_Charts.iloc[:, np.r_[3, 70, 69, 82:84]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
métricas_ameaça_aérea = ['Jogadas de cabeça (p90)', 
                            'Duelos aéreos vencidos no ataque (%)', 
                            'Duelos aéreos vencidos no ataque (p90)', 
...
#Plotar Primeiro Gráfico - Radar de Percentis do Jogador na liga:
st.markdown("---")
st.markdown("<h3 style='text-align: center; color: blue; '>Percentis e Métricas de<br>Ameaça Aérea</h3>", unsafe_allow_html=True)

Ameaça_Aérea_Atacante_Charts = Atacante_Charts_1.copy()

#Collecting data to plot
metrics = Ameaça_Aérea_Atacante_Charts.iloc[:, np.r_[3, 33:38]].reset_index(drop=True)
## parameter names
params = list(metrics.columns[1:])
...
jogador_1_scores = jogador_1_scores[
((jogador_1_scores['Atleta'] == jogador_1) & (jogador_1_scores['Clube'] == equipe_1) & (jogador_1_scores['Temporada'] == temporada_1))]
jogador_1_scores = jogador_1_scores.iloc[:, np.r_[3, 13:18]].reset_index(drop=True)
jogador_1_scores = jogador_1_scores.round(decimals=2)
jogador_1_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_1_percs = jogador_1_percs[
((jogador_1_percs['Atleta'] == jogador_1) & (jogador_1_percs['Clube'] == equipe_1)  & (jogador_1_percs['Temporada'] == temporada_1))]
jogador_1_percs = jogador_1_percs.iloc[:, np.r_[3, 33:38]].reset_index(drop=True)
jogador_1_percs = jogador_1_percs.round(decimals=0)
jogador_1_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_1 + "_percent"
jogador_1_percs.iloc[0, 0] = jogador_1 + "_percent"
...
jogador_1_scores = jogador_1_scores.drop(jogador_1_scores.index[0])  # Drop the old header row
jogador_1_scores = jogador_1_scores.reset_index(drop=True)
jogador_1_scores.insert(0, 'Métricas', métricas_ameaça_aérea)
...
jogador_2_scores = jogador_2_scores[
((jogador_2_scores['Atleta'] == jogador_2) & (jogador_2_scores['Clube'] == equipe_2) & (jogador_2_scores['Temporada'] == temporada_2))]
jogador_2_scores = jogador_2_scores.iloc[:, np.r_[3, 13:18]].reset_index(drop=True)
jogador_2_scores = jogador_2_scores.round(decimals=2)
jogador_2_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_2_percs = jogador_2_percs[
((jogador_2_percs['Atleta'] == jogador_2) & (jogador_2_percs['Clube'] == equipe_2)  & (jogador_2_percs['Temporada'] == temporada_2))]
jogador_2_percs = jogador_2_percs.iloc[:, np.r_[3, 33:38]].reset_index(drop=True)
jogador_2_percs = jogador_2_percs.round(decimals=0)
jogador_2_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_2 + "_percent"
jogador_2_percs.iloc[0, 0] = jogador_2 + "_percent"
...
jogador_2_scores = jogador_2_scores.drop(jogador_2_scores.index[0])  # Drop the old header row
jogador_2_scores = jogador_2_scores.reset_index(drop=True)
jogador_2_scores.insert(0, 'Métricas', métricas_ameaça_aérea)
...
métricas_conexão_ofensiva = ['Perdas de posse (p90)', 
                                'Retenção de posse sob pressão (p90)', 
                                'Resistência à pressão (%)', 
                                'Duelos aéreos vencidos (%)', 
                                'Recepção de bolas longas (p90)', 
                                'Conexões ofensivas (p90)'
]

#Plotar Primeiro Gráfico - Radar de Percentis do Jogador na liga:
st.markdown("---")
st.markdown("<h3 style='text-align: center; color: blue; '>Percentis e Métricas de<br>Conexão Ofensiva</h3>", unsafe_allow_html=True)

Conexão_Ofensiva_Atacante_Charts = Atacante_Charts_1.copy()

#Collecting data to plot
metrics = Conexão_Ofensiva_Atacante_Charts.iloc[:, np.r_[3, 49, 47, 48, 36, 67, 68]].reset_index(drop=True)
...
jogador_1_scores = jogador_1_scores[
((jogador_1_scores['Atleta'] == jogador_1) & (jogador_1_scores['Clube'] == equipe_1) & (jogador_1_scores['Temporada'] == temporada_1))]
jogador_1_scores = jogador_1_scores.iloc[:, np.r_[3, 29, 27, 28, 16, 47, 48]].reset_index(drop=True)
jogador_1_scores = jogador_1_scores.round(decimals=2)
jogador_1_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_1_percs = jogador_1_percs[
((jogador_1_percs['Atleta'] == jogador_1) & (jogador_1_percs['Clube'] == equipe_1)  & (jogador_1_percs['Temporada'] == temporada_1))]
jogador_1_percs = jogador_1_percs.iloc[:, np.r_[3, 49, 47, 48, 36, 67, 68]].reset_index(drop=True)
jogador_1_percs = jogador_1_percs.round(decimals=0)
jogador_1_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_1 + "_percent"
jogador_1_percs.iloc[0, 0] = jogador_1 + "_percent"
...
jogador_1_scores = jogador_1_scores.drop(jogador_1_scores.index[0])  # Drop the old header row
jogador_1_scores = jogador_1_scores.reset_index(drop=True)
jogador_1_scores.insert(0, 'Métricas', métricas_conexão_ofensiva)
...
jogador_2_scores = jogador_2_scores[
((jogador_2_scores['Atleta'] == jogador_2) & (jogador_2_scores['Clube'] == equipe_2) & (jogador_2_scores['Temporada'] == temporada_2))]
jogador_2_scores = jogador_2_scores.iloc[:, np.r_[3, 29, 27, 28, 16, 47, 48]].reset_index(drop=True)
jogador_2_scores = jogador_2_scores.round(decimals=2)
jogador_2_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_2_percs = jogador_2_percs[
((jogador_2_percs['Atleta'] == jogador_2) & (jogador_2_percs['Clube'] == equipe_2)  & (jogador_2_percs['Temporada'] == temporada_2))]
jogador_2_percs = jogador_2_percs.iloc[:, np.r_[3, 49, 47, 48, 36, 67, 68]].reset_index(drop=True)
jogador_2_percs = jogador_2_percs.round(decimals=0)
jogador_2_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_2 + "_percent"
jogador_2_percs.iloc[0, 0] = jogador_2 + "_percent"
...
jogador_2_scores = jogador_2_scores.drop(jogador_2_scores.index[0])  # Drop the old header row
jogador_2_scores = jogador_2_scores.reset_index(drop=True)
jogador_2_scores.insert(0, 'Métricas', métricas_conexão_ofensiva)
...
Movimentação_Ofensiva_Atacante_Charts = Atacante_Charts_1.copy()

#Collecting data to plot
metrics = Movimentação_Ofensiva_Atacante_Charts.iloc[:, np.r_[3, 38, 92:94, 41]].reset_index(drop=True)
...
Criação_Oportunidades_Atacante_Charts = Atacante_Charts_1.copy()

#Collecting data to plot
metrics = Criação_Oportunidades_Atacante_Charts.iloc[:, np.r_[3, 86, 88:92]].reset_index(drop=True)
...
Finalização_Atacante_Charts = Atacante_Charts_1.copy()

#Collecting data to plot
metrics = Finalização_Atacante_Charts.iloc[:, np.r_[3, 64:67, 40]].reset_index(drop=True)
...
métricas_oportunismo = ['xG (pToque na área)', 
                        'Gols (pToque na área)', 
                        'Conversão de finalizações (%)', 
                        'Gols (p90)'
                        ]
...
#Plotar Primeiro Gráfico - Radar de Percentis do Jogador na liga:
st.markdown("---")
st.markdown("<h3 style='text-align: center; color: blue; '>Percentis e Métricas de<br>Oportunismo</h3>", unsafe_allow_html=True)

Oportunismo_Atacante_Charts = Atacante_Charts_1.copy()

#Collecting data to plot
metrics = Oportunismo_Atacante_Charts.iloc[:, np.r_[3, 80:82, 57, 39]].reset_index(drop=True)
...
jogador_1_scores = jogador_1_scores[
((jogador_1_scores['Atleta'] == jogador_1) & (jogador_1_scores['Clube'] == equipe_1) & (jogador_1_scores['Temporada'] == temporada_1))]
jogador_1_scores = jogador_1_scores.iloc[:, np.r_[3, 60:62, 37, 19]].reset_index(drop=True)
jogador_1_scores = jogador_1_scores.round(decimals=2)
jogador_1_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_1_percs = jogador_1_percs[
((jogador_1_percs['Atleta'] == jogador_1) & (jogador_1_percs['Clube'] == equipe_1)  & (jogador_1_percs['Temporada'] == temporada_1))]
jogador_1_percs = jogador_1_percs.iloc[:, np.r_[3, 80:82, 57, 39]].reset_index(drop=True)
jogador_1_percs = jogador_1_percs.round(decimals=0)
jogador_1_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_1 + "_percent"
jogador_1_percs.iloc[0, 0] = jogador_1 + "_percent"
...
jogador_1_scores = jogador_1_scores.drop(jogador_1_scores.index[0])  # Drop the old header row
jogador_1_scores = jogador_1_scores.reset_index(drop=True)
jogador_1_scores.insert(0, 'Métricas', métricas_oportunismo)
...
jogador_2_scores = jogador_2_scores[
((jogador_2_scores['Atleta'] == jogador_2) & (jogador_2_scores['Clube'] == equipe_2) & (jogador_2_scores['Temporada'] == temporada_2))]
jogador_2_scores = jogador_2_scores.iloc[:, np.r_[3, 60:62, 37, 19]].reset_index(drop=True)
jogador_2_scores = jogador_2_scores.round(decimals=2)
jogador_2_scores.rename(columns={'Atleta': 'Métricas'}, inplace=True)
...
jogador_2_percs = jogador_2_percs[
((jogador_2_percs['Atleta'] == jogador_2) & (jogador_2_percs['Clube'] == equipe_2)  & (jogador_2_percs['Temporada'] == temporada_2))]
jogador_2_percs = jogador_2_percs.iloc[:, np.r_[3, 80:82, 57, 39]].reset_index(drop=True)
jogador_2_percs = jogador_2_percs.round(decimals=0)
jogador_2_percs.rename(columns={'Atleta': 'Métricas'}, inplace=True)
# Replace the cell at [0, 0] with jogador_2 + "_percent"
jogador_2_percs.iloc[0, 0] = jogador_2 + "_percent"
...
jogador_2_scores = jogador_2_scores.drop(jogador_2_scores.index[0])  # Drop the old header row
jogador_2_scores = jogador_2_scores.reset_index(drop=True)
jogador_2_scores.insert(0, 'Métricas', métricas_oportunismo)
